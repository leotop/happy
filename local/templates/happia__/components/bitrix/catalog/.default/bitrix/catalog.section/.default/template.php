...
<ul class="category-products products-grid">
	<?
foreach ($arResult['ITEMS'] as $key => $arItem)
{
	...
	<li class="item <? echo ($arItem['SECOND_PICT'] ? 'bx_catalog_item double' : 'bx_catalog_item'); ?>">

			<span class="bx_catalog_item_container item-container" id="<? echo $strMainID; ?>">

				<span class="sku">Арт.: <?=$arItem['PROPERTIES']['ARTNUMBER']['VALUE'] ?></span>
				...
				<a id="<? echo $arItemIDs['PICT']; ?>" href="<? echo $arItem['DETAIL_PAGE_URL']; ?>" class="product-image image1" title="<? echo $imgTitle; ?>">
				...
				<? if ($arItem['SECOND_PICT']) { ?>
					...
					<a id="<? echo $arItemIDs['SECOND_PICT']; ?>" href="<? echo $arItem['DETAIL_PAGE_URL']; ?>" class="bx_catalog_item_images_double product-image image2" title="<? echo $imgTitle; ?>">
			...
			<h2 class="bx_catalog_item_title product-name">
			...
			<div class="price-box bx_catalog_item_price">
			...
			<? if (!isset($arItem['OFFERS']) || empty($arItem['OFFERS'])) { ?>
				...
				<? // Кнопка купить для простого товара ?>

				<div class="bx_catalog_item_controls button-cart">
					<? if ($arItem['CAN_BUY']) { ?>
						
						<? if ('Y' == $arParams['USE_PRODUCT_QUANTITY']) { ?>
							<div class="bx_catalog_item_controls_blockone input-group product-qty">

								<input type="text" class="bx_col_input form-control qty" id="<? echo $arItemIDs['QUANTITY']; ?>" name="<? echo $arParams["PRODUCT_QUANTITY_VARIABLE"]; ?>" value="<? echo $arItem['CATALOG_MEASURE_RATIO']; ?>">
								
								<a id="<? echo $arItemIDs['QUANTITY_UP']; ?>" href="javascript:void(0)" class="bx_bt_button_type_2 bx_small input-group-addon product-plus" rel="nofollow"><i class="fa fa-plus"></i></a>
								
								<a id="<? echo $arItemIDs['QUANTITY_DOWN']; ?>" href="javascript:void(0)" class="bx_bt_button_type_2 bx_small input-group-addon product-minus" rel="nofollow"><i class="fa fa-minus"></i></a>
							</div>
						<? } ?>
			...
			<? } else { ?>
				...
				<? if ('Y' == $arParams['PRODUCT_DISPLAY_MODE']) { ?>
					...
					<div class="bx_catalog_item_controls no_touch button-cart">
						...
						<? if ($arParams['DISPLAY_COMPARE']) { ?>
							...
							<div class="bx_catalog_item_controls_blocktwo">
								<a id="<? echo $arItemIDs['COMPARE_LINK']; ?>" class="bx_bt_button_type_2 bx_medium button btn-cart" href="javascript:void(0)"><? echo $compareBtnMessage; ?></a>
							</div>
						<? } ?>
					</div>
				...
				<? } else { ?>
					...
					<div class="bx_catalog_item_controls no_touch button-cart">
						<a class="bx_bt_button_type_2 bx_medium button btn-cart" href="<? echo $arItem['DETAIL_PAGE_URL']; ?>"><?
