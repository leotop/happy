	...
	<div id="<? echo $arItemIDs['ID']; ?>">
	    ...
	    <div class="product-img-box" id="<? echo $arItemIDs['BIG_SLIDER_ID']; ?>">
			...
			<div class="product-image">
					...
					<? $main_thumb = CFile::ResizeImageGet($arFirstPhoto["ID"], array('width'=>500, 'height'=>500), BX_RESIZE_IMAGE_EXACT, true);?>
						
						<a href="<? echo $arFirstPhoto['SRC'];?>" title="<? echo $strTitle; ?>" class="fancybox" rel="groupimages" data-fancybox-group="images">
							<img id="<? echo $arItemIDs['PICT']; ?>" src="<? echo $main_thumb; ?>" alt="<? echo $strAlt; ?>" title="<? echo $strTitle; ?>">
						</a>
		    				...
		    				<ul id="<? echo $arItemIDs['SLIDER_LIST']; ?>">
								<? if($arResult['PROPERTIES']['YOUTUBE']['VALUE']) { ?>
									<li>
										<a class="cnt fancybox-various fancybox.iframe" rel="images" 
										   href="http://www.youtube.com/embed/<? echo $arResult['PROPERTIES']['YOUTUBE']['VALUE']?>?autoplay=0">
											<img src="<? echo 'http://img.youtube.com/vi/' . $arResult['PROPERTIES']['YOUTUBE']['VALUE'] . '/default.jpg' ?>" width="180"/>
										</a>
									</li>			
								<? }?>
								<? foreach ($arResult['MORE_PHOTO'] as &$arOnePhoto) { ?>
		    						...
		    						<li data-value="<? echo $arOnePhoto['ID']; ?>">
		    							...
		    							<a href="<? echo $arOnePhoto['SRC'];?>" class="fancybox" data-fancybox-group="images" style="display:none"></a>
		    						</li>
								<? }
		        				unset($arOnePhoto); ?>
		    				</ul>
			   			...
			   			<div class="<? echo $strClass; ?> jcarousel-wrapper more-views" id="<? echo $arItemIDs['SLIDER_CONT_OF_ID'].$arOneOffer['ID']; ?>" style="display: <? echo $strVisible; ?>;">
			    			<div class="jcarousel jcarousel-more-views" id="jcarousel-more-views-<? echo $arItemIDs['SLIDER_LIST_OF_ID'].$arOneOffer['ID']; ?>">
		    					<ul id="<? echo $arItemIDs['SLIDER_LIST_OF_ID'].$arOneOffer['ID']; ?>">
									<? if($arResult['PROPERTIES']['YOUTUBE']['VALUE']) { ?>
										<li>
											<a class="cnt fancybox-various fancybox.iframe" data-fancybox-group="images" 
											   href="http://www.youtube.com/embed/<? echo $arResult['PROPERTIES']['YOUTUBE']['VALUE']?>?autoplay=0">
												<img src="<? echo 'http://img.youtube.com/vi/' . $arResult['PROPERTIES']['YOUTUBE']['VALUE'] . '/default.jpg' ?>" width="180"/>
											</a>
										</li>			
...
<!-- <pre><? //print_r($arResult['SKU_PROPS']) ?></pre> -->
...
//  ".default",
//    Array(
// "ELEMENT_ID" => $arResult['ID'], 	# ID элемента инфоблока
