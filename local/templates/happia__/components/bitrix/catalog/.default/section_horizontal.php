...
// Get the custom attribute IS_MAIN_CATEGORY
// if 1 - show sub-categories
// if 0 or '' - show items
// $fSections = CIBlockSection::GetList(
//     false,
//     Array("IBLOCK_ID" => 2, "ID" => $arResult['VARIABLES']['SECTION_ID'], "ACTIVE"=>"Y", "GLOBAL_ACTIVE"=>"Y", "SECTION_ACTIVE" => "Y"),
//     false,
//     Array("UF_IS_MAIN_CATEGORY"),
//     false
// );
// $flSections = $fSections->Fetch();
// $is_main_category = $flSections['UF_IS_MAIN_CATEGORY'];
?>



<?
// Get count of items in the section including sub-sections
$arFilter = Array(
