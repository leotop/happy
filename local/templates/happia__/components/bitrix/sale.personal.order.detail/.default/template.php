...
<?else:?>
	...
	<div class="bx_my_order_switch">
		<a class="bx_mo_link btn btn-default" href="<?=$arResult["URL_TO_LIST"]?>">
	...
	<div class="bx_order_list">
			...
			<table class="table bx_order_list_table">
				...
				<tbody>
					...
					<?if(intval($arResult["USER_ID"])):?>
						<tr>
							<td colspan="2"><strong><?=GetMessage('SPOD_ACCOUNT_DATA')?></strong></td>
						</tr>
					...
					*/?>
					...
					<?if (isset($arResult["ORDER_PROPS"])):?>
						<?foreach($arResult["ORDER_PROPS"] as $prop):?>
							...
							<?if($prop["SHOW_GROUP_NAME"] == "Y"):?>
								...
								<tr>
									<td colspan="2"><strong><?=$prop["GROUP_NAME"]?></strong></td>
								</tr>
					...
					<tr>
						<td colspan="2"><strong><?=GetMessage("SPOD_ORDER_PAYMENT")?></strong></td>
					</tr>
					<tr class="no-border">
		...
		<div class="table-responsive">
			<table class="table bx_order_list_table_order">
				<thead>
					<tr>			
					...
					<?foreach($arResult["BASKET"] as $prod):?>
						<tr>
							...
							<?if($arResult['HAS_PROPS']):?>
								...
								?>
								<td class="custom text-center"> <?if($actuallyHasProps):?><span class="fm"><?=GetMessage('SPOD_PROPS')?>:</span><?endif?>

									<table cellspacing="0" class="w100 bx_ol_sku_prop">
										<?if($actuallyHasProps):?>
		...
		<table class="bx_control_table" style="width: 100%;">
			<tr>
				<td>  <a href="<?=$arResult["URL_TO_LIST"]?>" class="btn btn-default bx_big bx_bt_button_type_2 bx_cart">
					<i class="fa fa-arrow-left"></i> 
