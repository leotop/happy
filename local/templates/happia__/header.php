...
<header class="mobile-header">     
    <div class="toggle-nav">
        <button type="button" class="navbar-toggle collapsed" data-toggle="offcanvas" data-target=".main-menu" data-canvas="body" data-placement="left" data-exclude=".header-top">
...
<div class="address-open address-both" style="display:none">
    ...
    <p class="title"><strong>Магазин «Хаппиа» в Санкт-Петербурге</strong></p>
    <div class="map">
