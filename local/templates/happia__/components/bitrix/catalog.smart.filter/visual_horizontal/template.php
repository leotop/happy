...
?>
<div class="bx_filter bx_horizontal category-filters">
						...
						<div class="bx_filter_parameters_box_container">
							<div class="bx_filter_parameters_box_container_block">
								<div class="bx_filter_input_container">
									<span class="price-tip price-tip-from">от</span>
									<input
										class="min-price"
										type="text"
							...
							<div class="bx_filter_parameters_box_container_block">
								<div class="bx_filter_input_container">
									<span class="price-tip price-tip-to">до</span>
									<input
										class="max-price"
										type="text"
